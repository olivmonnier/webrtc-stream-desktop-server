...
function onIceCandidate(event) {
  iceCandidate(event, function () {
    return serverConnection.emit('message', JSON.stringify({ 'ice': event.candidate, 'uuid': uuid }));
  });
}
...
function onMessageFromServer(message) {
  ...
  var signalState = peerConnection.signalingState;
  ...
  if (signal.sdp && signalState !== 'have-remote-offer') {
    peerConnection.setRemoteDescription(signal.sdp).then(function () {
      ...
      if (signal.sdp.type == 'offer') {
        console.log('offer');
        createAnswer(peerConnection, function () {
          return serverConnection.emit('message', JSON.stringify({ 'sdp': peerConnection.localDescription, 'uuid': uuid }));
        });
      }
    }).catch(errorHandler);
...
},{"../../utils/iceServersAdress":47,"../../utils/limitBandwidth":48,"../../utils/peerConnection":49,"../../utils/uuid":50,"./getQueryStringValue":45,"socket.io-client":34}],47:[function(require,module,exports){
'use strict';
...
},{"./limitBandwidth":48}],50:[function(require,module,exports){
'use strict';
